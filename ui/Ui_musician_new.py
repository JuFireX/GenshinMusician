...
################################################################################
## Form generated from reading UI file 'musician_new.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/res/icon light mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/res/run dark mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/res/pause dark mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/icons/res/stop dark mode.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
